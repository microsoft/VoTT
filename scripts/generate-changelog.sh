...
# Grab all non-merge commits (from PRs)
...
# quickly became untenable. Perl and a couple other solutions come to mind,
...
# TODO: see if additional configuration (username, email, etc.) are required to push changes to the remote
git add CHANGELOG.md
git commit -m "ci: update changelog for ${TO_COMMIT} release"
git push
