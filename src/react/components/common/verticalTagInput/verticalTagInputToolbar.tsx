...
export default function VerticalTagInputToolbar(props: IVerticalTagInputToolbarProps) {
    ...
    return (
        <div className="tag-input-toolbar">
            <i className="tag-input-toolbar-icon fas fa-lock" onClick={(e) => handleLock(selectedTag, onLockTag)}></i>
            <i className="tag-input-toolbar-icon fas fa-edit" onClick={(e) => handleEdit(selectedTag, onEditTag)}></i>
            <i className="tag-input-toolbar-icon fas fa-arrow-circle-up" onClick={(e) => handleArrowUp(selectedTag, onReorder)}></i>
            <i className="tag-input-toolbar-icon fas fa-arrow-circle-down" onClick={(e) => handleArrowDown(selectedTag, onReorder)}></i>
            <i className="tag-input-toolbar-icon fas fa-trash" onClick={(e) => handleDelete(selectedTag, onDelete)}></i>
        </div>
    )
}
