...
describe("Editor Canvas", () => {
    ...
    it("onSelectionEnd adds region to asset and selects it", () => {
        ...
        const original: IAssetMetadata = {
            ...
            metadata: canvas.props.selectedAsset.metadata,
    ...
    function cloneWithUpdatedRegionTags(original: IAssetMetadata, regionId: string, tag: string) {
        return {
            ...original,
            regions: original.regions.map((r) => {
                if (r.id === regionId) {
    ...
    it("Applies single tag to selected region", () => {
        ...
        expect(wrapper.state().currentAsset.regions[0].tag).toEqual(newTag);
    });
    ...
    it("Removes old locked tag from selected region", () => {
        ...
        expect(wrapper.state().currentAsset.regions[0].tag).toEqual("");
    });
