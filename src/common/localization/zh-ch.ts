...
export const chinese: IAppStrings = {
    ...
    homePage: {
        ...
        importProject: {
            ...
            confirmation: "您确定要将项目$ {project.file.name}项目设置转换为v2格式吗？我们建议您首先备份项目文件。" // Are you sure you want to convert project ${project.file.name} project settings to v2 format? We recommend you backup the project file first.
        },
        messages: {
    ...
    editorPage: {
        ...
        tags: {
            ...
            delete: {
                ...
                confirmation: "您确定要删除此标签吗？它将在所有资产中删除，并且唯一标记的任何区域也将被删除" // Are you sure you want to delete this tag? It will be deleted throughout all assets and any regions where this is the only tag will also be deleted
            }
        },
        canvas: {
            removeAllRegions: {
            ...
            common: {
                properties: {
                    ...
                    includeImages: {
                        ...
                        description: "タ是否在目标连接中包括二进制映像资产" // Whether or not to include binary image assets in target connection
                    }
                }
            },
            vottJson: {
