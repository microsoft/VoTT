...
export const chinese: IAppStrings = {
    ...
    homePage: {
        ...
        importProject: {
            ...
            confirmation: "您确定要将项目$ {project.file.name}设置转换为v2格式吗？我们建议您首先备份项目文件。" // Are you sure you want to convert project ${project.file.name} project settings to v2 format? We recommend you backup the project file first.
        },
        messages: {
    ...
    appSettings: {
        ...
        securityTokens: {
            ...
            description: "安全令牌用于加密项目配置中的敏感数据" // Security tokens are used to encrypt sensitive data within your project configuration
        },
        version: {
    ...
    connections: {
        ...
        imageCorsWarning: "警告：在Web浏览器中使用VoTT时，由于CORS（跨源资源共享）限制，来自Bing Image Search的某些资产可能无法正确导出。", // Warning: When using VoTT in a Web browser, some assets from Bing Image Search may not export correctly due to CORS (Cross Origin Resource Sharing) restrictions.
        blobCorsWarning: "警告：必须在Azure Blob存储帐户上启用CORS（跨域资源共享），才能将其用作源或目标连接。 {0}中提供了有关启用CORS的更多信息。", // Warning: CORS (Cross Domain Resource Sharing) must be enabled on the Azure Blob Storage account, in order to use it as a source or target connection. More information on enabling CORS can be found in the {0}
        ...
        providers: {
            azureBlob: {
                ...
                sas: {
                    title: "SAS", // SAS
                    description: "用于验证Blob存储帐户的共享访问签名" // Shared access signature used to authenticate to the blob storage account
                },
                createContainer: {
                    title: "创建容器", // Create Container
                    description: "创建blob容器（如果尚不存在）" // Creates the blob container if it does not already exist
                }
            },
            bing: {
    ...
    editorPage: {
        ...
        tags: {
            ...
            rename: {
                ...
                confirmation: "您确定要重命名此标签吗？它将在所有资产中重命名" // Are you sure you want to rename this tag? It will be renamed throughout all assets
            },
            delete: {
                title: "删除标签", // Delete Tag
                confirmation: "您确定要删除此标签吗？它将在所有资产中删除，并且仅使用此标签标记的任何区域也将被删除" // Are you sure you want to delete this tag? It will be deleted throughout all assets and any regions where this is the only tag will also be deleted
            }
        },
        canvas: {
            removeAllRegions: {
        ...
        messages: {
            enforceTaggedRegions: {
                ...
                description: "1个或多个区域尚未被标记。在继续下一个资产之前，请确保所有区域均已标记。" // 1 or more regions have not been tagged.  Ensure all regions are tagged before continuing to next asset.
            }
        }
    },
    export: {
            ...
            common: {
                properties: {
                    ...
                    includeImages: {
                        ...
                        description: "是否在目标连接中包括二值化图像资产" // Whether or not to include binary image assets in target connection
                    }
                }
            },
            vottJson: {
        ...
        form: {
            properties: {
                ...
                autoDetect: {
                    ...
                    description: "在资产之间导航时是否自动进行预测" // Whether or not to automatically make predictions as you navigate between assets
                },
                modelPath: {
    ...
    errors: {
        ...
        projectUploadError: {
            ...
            message: "上传文件时出错。请确认文件格式正确，然后重试。" // There was an error uploading the file. Please verify the file is of the correct format and try again.
        },
        genericRenderError: {
        ...
        projectInvalidSecurityToken: {
            ...
            message: "项目引用的安全令牌无效。验证是否在您的应用程序设置中正确设置了项目的安全令牌" // The security token referenced by the project is invalid. Verify that the security token for the project has been set correctly within your application settings
        },
        projectInvalidJson: {
            title: "解析项目文件时出错", // Error parsing project file
            message: "所选的项目文件不包含有效的JSON。请重试该文件。" // The selected project files does not contain valid JSON. Please check the file any try again.
        },
        projectDeleteError: {
            title: "删除项目时出错", // Error deleting project
            message: "删除项目时发生错误。验证项目文件和安全令牌是否存在，然后重试" // An error occured while deleting the project. Validate the project file and security token exist and try again
        },
        securityTokenNotFound: {
            title: "加载项目文件时出错", // Error loading project file
            message: "在当前的应用程序设置中找不到该项目引用的安全令牌。验证安全令牌是否存在，然后尝试重新加载项目。" // The security token referenced by the project cannot be found in your current application settings. Verify the security token exists and try to reload the project.
        },
        canvasError: {
            title: "加载画布时出错", // Error loading canvas
            message: "加载画布时发生错误，请检查项目的资产，然后重试。" // There was an error loading the canvas, check the project's assets and try again.
        },
        importError: {
            title: "导入V1项目时出错", // Error importing V1 project
            message: "导入V1项目时出错。检查项目文件，然后重试" // There was an error importing the V1 project. Check the project file and try again
        },
        ...
        exportFormatNotFound: {
            ...
            message: "项目缺少导出格式。请在导出设置页面中选择一种导出格式。" // Project is missing export format.  Please select an export format in the export setting page.
        },
        activeLearningPredictionError: {
            title: "主动学习错误", // Active Learning Error
            message: "预测当前资产中的区域时发生错误。请验证您的有效学习配置，然后重试" // An error occurred while predicting regions in the current asset. Please verify your active learning configuration and try again
        },
    },
};
