  ...
  this.init = function() {
    ...
    $('#video-tagging').on('stepFwdClicked-BeforeStep', () => {
      ...
      if (regionCount) {
        ...
        var stanH = self.videotagging.video.videoHeight / self.videotagging.video.offsetHeight;
        $.map($('.regionCanvas'), (regionCanvas, i) => {
    ...
    function afterStep() {
      ...
      if (regionsToTrack.length) {
        ...
        var stanW = self.videotagging.video.offsetWidth / self.videotagging.video.videoWidth;


        var stanH = self.videotagging.video.offsetHeight / self.videotagging.video.videoHeight;
